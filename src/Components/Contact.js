         ...
         <div className="row">
            <div className="eight columns">
               ...
               <form id="contactForm" name="contactForm">
                  ...
                  <div>
						   <label htmlFor="contactEmail">Эл. почта <span className="required">*</span></label>
                  ...
                  <div>
                     <label htmlFor="contactMessage">Письмо <span className="required">*</span></label>
                  ...
                  <div>
                     <button type='submit' onClick={handleClick} className="submit">Отправить</button>
           ...
           <div id="message-warning"> Error boy</div>
                  ...
                  <i className="fa fa-check"></i>Ваше сообщение отправлено, большое спасибо!<br />
				   </div>
           </div>
